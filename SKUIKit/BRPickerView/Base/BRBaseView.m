...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = RGB_HEX(0xF5F5F5, 1.0f);
    }
    return _topView;
}
...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        [_leftBtn setTitleColor:RGB_HEX(0x00b400, 1.0) forState:UIControlStateNormal];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        [_rightBtn setTitleColor:RGB_HEX(0x00b400, 1.0) forState:UIControlStateNormal];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = RGB_HEX(0x00b400, 1.0);
